...
interface AddBOMFieldDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

const AddBOMFieldDialog = ({ open, onOpenChange }: AddBOMFieldDialogProps) => {
  const { createField } = useBOMFieldMutations();
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle>Add BOM Field</DialogTitle>
        </DialogHeader>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input {...field} placeholder="e.g., material_grade" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input {...field} placeholder="e.g., Material Grade" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
...
export default AddBOMFieldDialog;
